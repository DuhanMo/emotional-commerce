...
//
//        val product1 = productJpaRepository.save(createProduct(brandId = brand1.id, name = "상품1", likeCount = 100L))
//        val product2 = productJpaRepository.save(createProduct(brandId = brand2.id, name = "상품2", likeCount = 200L))
//
//        When("상품 목록을 조회하면") {
...
//        productJpaRepository.save(createProduct(brandId = 999L, name = "브랜드 미존재 상품", likeCount = 50))
//
//        When("상품 목록을 조회하면") {
//            Then("예외가 발생한다") {
