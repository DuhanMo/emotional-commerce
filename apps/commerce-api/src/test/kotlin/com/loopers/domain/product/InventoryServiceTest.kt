...
import com.loopers.domain.product.InventoryReservationCommand.InventoryItem
            ...
            When("충분한 재고가 있는 경우") {
                ...
                inventoryService.reserveAll(
                    InventoryReservationCommand(
                        orderId = 1L,
                        items = listOf(InventoryItem(skuId = 1L, quantity = 2L), InventoryItem(skuId = 2L, quantity = 1L)),
                    ),
                )
