...
data class UserResponse(
    @field:Schema(description = "식별자", example = "1")
    val id: Long,
    @field:Schema(description = "로그인 아이디", example = "test123")
    val loginId: String,
    @field:Schema(description = "이메일 주소", example = "test@test.com")
    val email: String,
    @field:Schema(description = "생년월일", example = "1995-03-15")
